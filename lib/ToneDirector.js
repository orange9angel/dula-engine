...
export const TONE = {
  // 战斗
  BATTLE_CRY:    { id: 'battle_cry',    pitch: +2, speed: 1.2,  volume: 1.1, breaks: [],       intensity: 0.9 },
  PAIN_SHOUT:    { id: 'pain_shout',    pitch: +4, speed: 1.3,  volume: 1.2, breaks: [],       intensity: 1.0 },
  PAIN_GRUNT:    { id: 'pain_grunt',    pitch: -1, speed: 0.8,  volume: 0.7, breaks: [],       intensity: 0.6 },
  VICTORY_LAUGH: { id: 'victory_laugh', pitch: +3, speed: 1.1,  volume: 1.0, breaks: [0.1],    intensity: 0.85 },
  TAUNT:         { id: 'taunt',         pitch: +1, speed: 0.95, volume: 0.9, breaks: [0.12],   intensity: 0.7 },
  BATTLE_WHISPER:{ id: 'battle_whisper',pitch: 0,  speed: 0.8,  volume: 0.5, breaks: [0.15],   intensity: 0.5 },

  // 情绪
  NEUTRAL:       { id: 'neutral',       pitch: 0,  speed: 1.0,  volume: 1.0, breaks: [],       intensity: 0.0 },
  HAPPY:         { id: 'happy',         pitch: +1, speed: 1.05, volume: 1.0, breaks: [0.05],   intensity: 0.5 },
  JOYFUL:        { id: 'joyful',        pitch: +2, speed: 1.15, volume: 1.05, breaks: [0.05],   intensity: 0.7 },
  SAD:           { id: 'sad',           pitch: -2, speed: 0.85, volume: 0.85, breaks: [0.15],   intensity: 0.6 },
  DESPAIR:       { id: 'despair',       pitch: -3, speed: 0.7,  volume: 0.75, breaks: [0.2],    intensity: 0.9 },
  ANGRY:         { id: 'angry',         pitch: +1, speed: 1.15, volume: 1.1, breaks: [0.08],   intensity: 0.8 },
  FURIOUS:       { id: 'furious',       pitch: +2, speed: 1.25, volume: 1.2, breaks: [0.05],   intensity: 1.0 },
  FEAR:          { id: 'fear',          pitch: +2, speed: 1.25, volume: 0.9, breaks: [0.05],   intensity: 0.7 },
  PANIC:         { id: 'panic',         pitch: +3, speed: 1.4,  volume: 1.0, breaks: [0.03],   intensity: 0.9 },
  SURPRISE:      { id: 'surprise',      pitch: +3, speed: 1.2,  volume: 1.0, breaks: [0.02],   intensity: 0.6 },
  SHOCK:         { id: 'shock',         pitch: +4, speed: 1.3,  volume: 1.1, breaks: [0.02],   intensity: 0.85 },
  DISGUST:       { id: 'disgust',       pitch: -1, speed: 0.9,  volume: 0.85, breaks: [0.1],    intensity: 0.5 },
  CONTEMPT:      { id: 'contempt',      pitch: -1, speed: 0.85, volume: 0.8, breaks: [0.15],   intensity: 0.6 },

  // 关系/社交
  FLIRT:         { id: 'flirt',         pitch: +1, speed: 0.9,  volume: 0.85, breaks: [0.1],    intensity: 0.4 },
  TEASE:         { id: 'tease',         pitch: +1, speed: 1.0,  volume: 0.9, breaks: [0.12],   intensity: 0.5 },
  MOCK:          { id: 'mock',          pitch: +1, speed: 0.95, volume: 0.9, breaks: [0.12],   intensity: 0.6 },
  SARCASM:       { id: 'sarcasm',       pitch: 0,  speed: 0.9,  volume: 0.9, breaks: [0.15],   intensity: 0.5 },
  RESPECTFUL:    { id: 'respectful',    pitch: -1, speed: 0.95, volume: 0.9, breaks: [0.1],    intensity: 0.3 },
  COMMAND:       { id: 'command',       pitch: 0,  speed: 1.1,  volume: 1.05, breaks: [0.08],   intensity: 0.7 },
  PLEAD:         { id: 'plead',         pitch: +1, speed: 0.85, volume: 0.85, breaks: [0.18],   intensity: 0.7 },

  // 特殊
  MONOLOGUE:     { id: 'monologue',     pitch: -1, speed: 0.85, volume: 0.9, breaks: [0.3],    intensity: 0.4 },
  NARRATION:     { id: 'narration',     pitch: -1, speed: 0.9,  volume: 0.9, breaks: [0.2],    intensity: 0.2 },
  WHISPER:       { id: 'whisper',       pitch: 0,  speed: 0.8,  volume: 0.4, breaks: [0.2],    intensity: 0.3 },
  SHOUT:         { id: 'shout',         pitch: +3, speed: 1.3,  volume: 1.2, breaks: [],       intensity: 0.9 },
  BREATH:        { id: 'breath',        pitch: 0,  speed: 0.6,  volume: 0.3, breaks: [0.5],    intensity: 0.1 },
  GASP:          { id: 'gasp',          pitch: +2, speed: 1.5,  volume: 0.9, breaks: [0.05],   intensity: 0.7 },
  LAUGH:         { id: 'laugh',         pitch: +2, speed: 1.1,  volume: 1.0, breaks: [0.08],   intensity: 0.6 },
  SOB:           { id: 'sob',           pitch: -2, speed: 0.7,  volume: 0.7, breaks: [0.25],   intensity: 0.8 },
};
